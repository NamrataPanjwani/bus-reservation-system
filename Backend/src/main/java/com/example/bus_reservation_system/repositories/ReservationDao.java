...
public interface ReservationDao extends JpaRepository<Reservation,Long> {
    ...
    @Query("SELECT new com.example.bus_reservation_system.entity.RevenueReport(r.bus.id, b.operator, b.busNumber, SUM(b.price)) " +
            "FROM Reservation r JOIN Bus b ON r.bus.id = b.id " +
            "WHERE b.operator = 'Rajvi Travels'" +
            "GROUP BY r.bus.id, b.operator, b.busNumber")
    List<RevenueReport> getTotalRevenueReport();
